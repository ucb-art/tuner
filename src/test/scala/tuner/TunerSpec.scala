...
class TunerTester[T <: Data](c: TunerBlock[T])(implicit val p: Parameters) extends DspBlockTester(c) with HasTunerGenParameters[T] {
  ...
  val input = Seq.fill(test_length)(Seq.fill(gk.lanesIn)(2.718281828))
